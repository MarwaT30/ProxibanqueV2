...
<body>
		...
		<div class="table-responsive">
			<table class="table table-striped">
				...
				<tbody>
					...
					<%=Utilejsp.tableauClient(user.getListClient()) %>
				</tbody>
			</table>
		</div>
	</div>
	...
	<script
		src="https://maxcdn.bootstrapcdn.com/bootstrap/3.2.0/js/bootstrap.min.js"></script>
		 <center>
		 <form class="form-signin" role="form" Action="ChoixClient" method="post">
        <h4>Choisir le n° de ligne du client</h4>
        <input class="input-control" name="login" placeholder="n° de ligne du client" required="" autofocus="" type="login"><br>
        <br>
             
        
        <button class="btn btn-lg btn-primary" type="submit">Afficher</button>
      </form>
      </center>
</body>
</html>